            ...
            (a.init = function (a, b, d, e) {
              ...
              (a.transition = function (a) {
                (this.active = !0),
                  ...
                  this.auto && ('auto' == this.el.style[this.name] && (this.update(this.get()), this.redraw()), 'auto' == a && (a = b.call(this))),
                  (this.nextStyle = a);
              }),
              (a.fallback = function (a) {
                var c = this.el.style[this.name] || this.convert(this.get(), this.type);
                (a = this.convert(a, this.type)),
                  this.auto && ('auto' == c && (c = this.convert(this.get(), this.type)), 'auto' == a && (a = b.call(this))),
                  (this.tween = new R({
                    from: c,
                    to: a,
          ...
          R = l(function (b) {
            ...
            (b.init = function (a) {
              ...
              void 0 === c && (c = l.from),
                void 0 === d && (d = l.to),
                (this.unit = a.unit || ''),
                'number' == typeof c && 'number' == typeof d ? ((this.begin = c), (this.change = d - c)) : this.format(d, c),
          ...
          if (typeof reducer(undefined, { type: type }) === 'undefined') {
            throw new Error(
              'Reducer "' +
                ...
                ("Don't try to handle " + _createStore__WEBPACK_IMPORTED_MODULE_0__['ActionTypes'].INIT + ' or other actions in "redux/*" ') +
...
*/
    ...
    /***/ function (module, __webpack_exports__, __webpack_require__) {
      ...
      /* WEBPACK VAR INJECTION */ (function (global, module) {
        /* harmony import */ var _ponyfill_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(184);
        /* global window */
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      var ReducedMotionTypes =
        ((_ReducedMotionTypes = {}),
        (0, _defineProperty2['default'])(_ReducedMotionTypes, TRANSFORM_MOVE, true),
        (0, _defineProperty2['default'])(_ReducedMotionTypes, TRANSFORM_SCALE, true),
        (0, _defineProperty2['default'])(_ReducedMotionTypes, TRANSFORM_ROTATE, true),
        (0, _defineProperty2['default'])(_ReducedMotionTypes, TRANSFORM_SKEW, true),
        (0, _defineProperty2['default'])(_ReducedMotionTypes, STYLE_SIZE, true),
        (0, _defineProperty2['default'])(_ReducedMotionTypes, STYLE_FILTER, true),
        _ReducedMotionTypes);
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      var willChangeProps = Object.freeze(
        ((_Object$freeze2 = {}),
        (0, _defineProperty2['default'])(_Object$freeze2, _IX2BrowserSupport.TRANSFORM_PREFIXED, TRANSFORM),
      ...
      function shouldNamespaceEventParameter(eventTypeId, _ref22) {
        ...
        return (
          (eventTypeId === _constants.EventTypeConsts.SCROLLING_IN_VIEW && (basedOn === _constants.EventBasedOn.ELEMENT || basedOn == null)) ||
          (eventTypeId === _constants.EventTypeConsts.MOUSE_MOVE && basedOn === _constants.EventBasedOn.ELEMENT)
        );
      }
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      var _default =
        ...
        (0, _defineProperty2['default'])(_default2, NAVBAR_CLOSE, getComponentInactiveOptions(false)),
...
Webflow.require('ix2').init({
  events: {
    ...
    'e-22': {
      ...
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: { selector: '.section-title', originalId: '5fc25a3797a8f4c9b2226ec5|6ff5df9b-bd9e-cb59-fc9c-f9c73cf3e065', appliesTo: 'CLASS' },
      targets: [{ selector: '.section-title', originalId: '5fc25a3797a8f4c9b2226ec5|6ff5df9b-bd9e-cb59-fc9c-f9c73cf3e065', appliesTo: 'CLASS' }],
      config: { loop: false, playInReverse: false, scrollOffsetValue: 20, scrollOffsetUnit: '%', delay: 0, direction: 'BOTTOM', effectIn: true },
      createdOn: 1594461090074
    },
    'e-32': {
      id: 'e-32',
      name: '',
      ...
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: { selector: '.section-title-left', originalId: '5fc25a3797a8f4c9b2226ec5|fcbfa713-38ee-18a0-5f3d-321dec6f271e', appliesTo: 'CLASS' },
      targets: [{ selector: '.section-title-left', originalId: '5fc25a3797a8f4c9b2226ec5|fcbfa713-38ee-18a0-5f3d-321dec6f271e', appliesTo: 'CLASS' }],
      config: { loop: false, playInReverse: false, scrollOffsetValue: 0, scrollOffsetUnit: '%', delay: 0, direction: 'BOTTOM', effectIn: true },
      createdOn: 1594461472695
    },
    'e-34': {
      id: 'e-34',
      name: '',
      ...
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: { selector: '.paragraph-left', originalId: '5fc25a3797a8f4c9b2226ec5|fcbfa713-38ee-18a0-5f3d-321dec6f2720', appliesTo: 'CLASS' },
      targets: [{ selector: '.paragraph-left', originalId: '5fc25a3797a8f4c9b2226ec5|fcbfa713-38ee-18a0-5f3d-321dec6f2720', appliesTo: 'CLASS' }],
      config: { loop: false, playInReverse: false, scrollOffsetValue: 0, scrollOffsetUnit: '%', delay: 0, direction: 'BOTTOM', effectIn: true },
      createdOn: 1594461481066
    },
    'e-38': {
      id: 'e-38',
      name: '',
      ...
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: { selector: '.top-line', originalId: '5fc25a3797a8f4c9b2226ec5|4c01ad2d-ae9e-6e31-53d9-9ac052e74ee7', appliesTo: 'CLASS' },
      targets: [{ selector: '.top-line', originalId: '5fc25a3797a8f4c9b2226ec5|4c01ad2d-ae9e-6e31-53d9-9ac052e74ee7', appliesTo: 'CLASS' }],
      config: { loop: false, playInReverse: false, scrollOffsetValue: 0, scrollOffsetUnit: '%', delay: 0, direction: 'BOTTOM', effectIn: true },
      createdOn: 1594461508046
    },
    'e-44': {
      id: 'e-44',
      name: '',
      ...
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: { selector: '.customers-text', originalId: '5fc25a3797a8f4c9b2226ec5|b1b764c4-5c61-48fd-aa75-c95b2e32c4b0', appliesTo: 'CLASS' },
      targets: [{ selector: '.customers-text', originalId: '5fc25a3797a8f4c9b2226ec5|b1b764c4-5c61-48fd-aa75-c95b2e32c4b0', appliesTo: 'CLASS' }],
      config: { loop: false, playInReverse: false, scrollOffsetValue: 30, scrollOffsetUnit: '%', delay: 0, direction: 'BOTTOM', effectIn: true },
      createdOn: 1594461766152
    },
    'e-46': {
      id: 'e-46',
      name: '',
      ...
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: { selector: '.grid-customers', originalId: '5fc25a3797a8f4c9b2226ec5|65116fa1-d0b5-ff31-a9d5-59932a64ebdc', appliesTo: 'CLASS' },
      targets: [{ selector: '.grid-customers', originalId: '5fc25a3797a8f4c9b2226ec5|65116fa1-d0b5-ff31-a9d5-59932a64ebdc', appliesTo: 'CLASS' }],
      config: { loop: false, playInReverse: false, scrollOffsetValue: 30, scrollOffsetUnit: '%', delay: 0, direction: 'BOTTOM', effectIn: true },
      createdOn: 1594461841226
    },
    'e-56': {
      id: 'e-56',
      name: '',
      animationType: 'preset',
      eventTypeId: 'SCROLL_INTO_VIEW',
      action: { id: '', actionTypeId: 'SLIDE_EFFECT', instant: false, config: { actionListId: 'slideInBottom', autoStopEventId: 'e-57' } },
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: { selector: '.insurance-block', originalId: '5fc25a3797a8f404cf226ec9|5b8abc47-3982-252f-4182-b815948074bc', appliesTo: 'CLASS' },
      targets: [{ selector: '.insurance-block', originalId: '5fc25a3797a8f404cf226ec9|5b8abc47-3982-252f-4182-b815948074bc', appliesTo: 'CLASS' }],
      config: { loop: false, playInReverse: false, scrollOffsetValue: 0, scrollOffsetUnit: '%', delay: 0, direction: 'BOTTOM', effectIn: true },
      createdOn: 1594463646855
    },
    'e-62': {
      id: 'e-62',
      name: '',
    ...
    'e-80': {
      ...
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: { id: '5fc25a3797a8f4c9b2226ec5|b028b1e2-556f-8059-cec0-1446b5d67cbd', appliesTo: 'ELEMENT', styleBlockIds: [] },
      targets: [{ id: '5fc25a3797a8f4c9b2226ec5|b028b1e2-556f-8059-cec0-1446b5d67cbd', appliesTo: 'ELEMENT', styleBlockIds: [] }],
      config: { loop: false, playInReverse: false, scrollOffsetValue: 20, scrollOffsetUnit: '%', delay: 0, direction: 'BOTTOM', effectIn: true },
      createdOn: 1613330426942
    },
    'e-120': {
      id: 'e-120',
      name: '',
    ...
    'e-184': {
      ...
      animationType: 'preset',
      eventTypeId: 'SCROLL_INTO_VIEW',
      action: { id: '', actionTypeId: 'SLIDE_EFFECT', instant: false, config: { actionListId: 'slideInBottom', autoStopEventId: 'e-185' } },
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: { id: '610ae74d5e52eb29faa2a0a4|4ca6bbab-8f11-2642-374a-a98c968c1c7f', appliesTo: 'ELEMENT', styleBlockIds: [] },
      targets: [{ id: '610ae74d5e52eb29faa2a0a4|4ca6bbab-8f11-2642-374a-a98c968c1c7f', appliesTo: 'ELEMENT', styleBlockIds: [] }],
      config: { loop: false, playInReverse: false, scrollOffsetValue: 20, scrollOffsetUnit: '%', delay: 0, direction: 'BOTTOM', effectIn: true },
      createdOn: 1628104526491
    },
    'e-186': {
      ...
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: { id: '610ae74d5e52eb29faa2a0a4|4ca6bbab-8f11-2642-374a-a98c968c1c88', appliesTo: 'ELEMENT', styleBlockIds: [] },
      targets: [{ id: '610ae74d5e52eb29faa2a0a4|4ca6bbab-8f11-2642-374a-a98c968c1c88', appliesTo: 'ELEMENT', styleBlockIds: [] }],
      config: { loop: false, playInReverse: false, scrollOffsetValue: 20, scrollOffsetUnit: '%', delay: 0.4, direction: 'BOTTOM', effectIn: true },
      createdOn: 1628104526491
    },
    'e-188': {
      id: 'e-188',
      ...
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: { id: '610ae74d5e52eb29faa2a0a4|4ca6bbab-8f11-2642-374a-a98c968c1c91', appliesTo: 'ELEMENT', styleBlockIds: [] },
      targets: [{ id: '610ae74d5e52eb29faa2a0a4|4ca6bbab-8f11-2642-374a-a98c968c1c91', appliesTo: 'ELEMENT', styleBlockIds: [] }],
      config: { loop: false, playInReverse: false, scrollOffsetValue: 20, scrollOffsetUnit: '%', delay: 0, direction: 'BOTTOM', effectIn: true },
      createdOn: 1628104526491
    },
    'e-196': {
      ...
      animationType: 'preset',
      eventTypeId: 'SCROLL_INTO_VIEW',
      action: { id: '', actionTypeId: 'SLIDE_EFFECT', instant: false, config: { actionListId: 'slideInBottom', autoStopEventId: 'e-197' } },
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: { id: '610ae74d5e52eb29faa2a0a4|4ca6bbab-8f11-2642-374a-a98c968c1cb9', appliesTo: 'ELEMENT', styleBlockIds: [] },
      targets: [{ id: '610ae74d5e52eb29faa2a0a4|4ca6bbab-8f11-2642-374a-a98c968c1cb9', appliesTo: 'ELEMENT', styleBlockIds: [] }],
      config: { loop: false, playInReverse: false, scrollOffsetValue: 20, scrollOffsetUnit: '%', delay: 0, direction: 'BOTTOM', effectIn: true },
      createdOn: 1628104526491
    },
    'e-200': {
      ...
      animationType: 'preset',
      eventTypeId: 'SCROLL_INTO_VIEW',
      action: { id: '', actionTypeId: 'SLIDE_EFFECT', instant: false, config: { actionListId: 'slideInBottom', autoStopEventId: 'e-201' } },
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: { id: '610ae74d5e52eb29faa2a0a4|4ca6bbab-8f11-2642-374a-a98c968c1ccb', appliesTo: 'ELEMENT', styleBlockIds: [] },
      targets: [{ id: '610ae74d5e52eb29faa2a0a4|4ca6bbab-8f11-2642-374a-a98c968c1ccb', appliesTo: 'ELEMENT', styleBlockIds: [] }],
      config: { loop: false, playInReverse: false, scrollOffsetValue: 20, scrollOffsetUnit: '%', delay: 0, direction: 'BOTTOM', effectIn: true },
      createdOn: 1628104526491
    },
    'e-204': {
      ...
      animationType: 'preset',
      eventTypeId: 'SCROLL_INTO_VIEW',
      action: { id: '', actionTypeId: 'SLIDE_EFFECT', instant: false, config: { actionListId: 'slideInBottom', autoStopEventId: 'e-205' } },
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: { id: '610ae74d5e52eb29faa2a0a4|4ca6bbab-8f11-2642-374a-a98c968c1cd5', appliesTo: 'ELEMENT', styleBlockIds: [] },
      targets: [{ id: '610ae74d5e52eb29faa2a0a4|4ca6bbab-8f11-2642-374a-a98c968c1cd5', appliesTo: 'ELEMENT', styleBlockIds: [] }],
      config: { loop: false, playInReverse: false, scrollOffsetValue: 20, scrollOffsetUnit: '%', delay: 0, direction: 'BOTTOM', effectIn: true },
      createdOn: 1628104526491
    },
    'e-236': {
      ...
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: { id: '5fc25a3797a8f4c9b2226ec5|11d65a6b-c981-599d-6732-b7dc70e1159f', appliesTo: 'ELEMENT', styleBlockIds: [] },
      targets: [{ id: '5fc25a3797a8f4c9b2226ec5|11d65a6b-c981-599d-6732-b7dc70e1159f', appliesTo: 'ELEMENT', styleBlockIds: [] }],
      config: { loop: false, playInReverse: false, scrollOffsetValue: 0, scrollOffsetUnit: '%', delay: 0, direction: 'BOTTOM', effectIn: true },
      createdOn: 1628105410625
    },
    'e-238': {
      id: 'e-238',
      name: '',
      ...
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: { id: '5fc25a3797a8f4c9b2226ec5|99eb08f3-4185-958c-94d3-95a906672561', appliesTo: 'ELEMENT', styleBlockIds: [] },
      targets: [{ id: '5fc25a3797a8f4c9b2226ec5|99eb08f3-4185-958c-94d3-95a906672561', appliesTo: 'ELEMENT', styleBlockIds: [] }],
      config: { loop: false, playInReverse: false, scrollOffsetValue: 0, scrollOffsetUnit: '%', delay: 0, direction: 'BOTTOM', effectIn: true },
      createdOn: 1628105443773
    },
    'e-240': {
      id: 'e-240',
      name: '',
      ...
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: { id: '5fc25a3797a8f4c9b2226ec5|aefb4a4b-a84d-6b01-0247-04a27a2e9b96', appliesTo: 'ELEMENT', styleBlockIds: [] },
      targets: [{ id: '5fc25a3797a8f4c9b2226ec5|aefb4a4b-a84d-6b01-0247-04a27a2e9b96', appliesTo: 'ELEMENT', styleBlockIds: [] }],
      config: { loop: false, playInReverse: false, scrollOffsetValue: 0, scrollOffsetUnit: '%', delay: 0, direction: 'BOTTOM', effectIn: true },
      createdOn: 1628870485736
    },
    'e-295': {
      id: 'e-295',
      name: '',
      animationType: 'preset',
      eventTypeId: 'SCROLL_INTO_VIEW',
      action: { id: '', actionTypeId: 'SLIDE_EFFECT', instant: false, config: { actionListId: 'slideInBottom', autoStopEventId: 'e-296' } },
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: { id: '610ae74d5e52eb29faa2a0a4|39d32f39-516f-744c-0272-6fab37c82143', appliesTo: 'ELEMENT', styleBlockIds: [] },
      targets: [{ id: '610ae74d5e52eb29faa2a0a4|39d32f39-516f-744c-0272-6fab37c82143', appliesTo: 'ELEMENT', styleBlockIds: [] }],
      config: { loop: false, playInReverse: false, scrollOffsetValue: 20, scrollOffsetUnit: '%', delay: 0, direction: 'BOTTOM', effectIn: true },
      createdOn: 1641475814901
    },
    'e-297': {
      id: 'e-297',
      name: '',
      animationType: 'preset',
      eventTypeId: 'SCROLL_INTO_VIEW',
      action: { id: '', actionTypeId: 'SLIDE_EFFECT', instant: false, config: { actionListId: 'slideInBottom', autoStopEventId: 'e-298' } },
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: { id: '610ae74d5e52eb29faa2a0a4|ab7b6b0e-6a4f-7494-06ea-3b019bb91065', appliesTo: 'ELEMENT', styleBlockIds: [] },
      targets: [{ id: '610ae74d5e52eb29faa2a0a4|ab7b6b0e-6a4f-7494-06ea-3b019bb91065', appliesTo: 'ELEMENT', styleBlockIds: [] }],
      config: { loop: false, playInReverse: false, scrollOffsetValue: 20, scrollOffsetUnit: '%', delay: 0.4, direction: 'BOTTOM', effectIn: true },
      createdOn: 1641490833081
    }
  },
  actionLists: {
    a: {
      ...
      createdOn: 1582807772950
    },
    'a-2': {
      id: 'a-2',
      title: 'FAQs Animation Open',
      actionItemGroups: [
        {
          actionItems: [
            {
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                easing: '',
                duration: 200,
                target: { useEventTarget: 'CHILDREN', selector: '.faqs-arrow', selectorGuids: ['94ecac62-3332-d14a-e3cc-706842fdc49b'] },
                zValue: 90,
                xUnit: 'DEG',
                yUnit: 'DEG',
                zUnit: 'DEG'
      ...
      createdOn: 1582807974665
    },
    'a-3': {
      id: 'a-3',
      title: 'FAQs Animation Close',
      actionItemGroups: [
        {
          actionItems: [
            {
      ...
      createdOn: 1582808326298
    },
    'a-4': {
      id: 'a-4',
      title: 'Home 1 Page Loading Animation',
      actionItemGroups: [
        {
          actionItems: [
            {
              ...
              config: {
                ...
                easing: '',
                duration: 500,
                target: { selector: '.nav-block', selectorGuids: ['6a1faffd-6104-4185-d7ad-6092394e0eb9'] },
                yValue: -100,
                xUnit: 'PX',
                yUnit: 'PX',
                zUnit: 'PX'
